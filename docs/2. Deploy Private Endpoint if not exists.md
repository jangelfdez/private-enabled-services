...
You can deploy a reference scenario from scratch using the [step-by-step-example-dine-privateEndpoint-singleSubscription-policy.ps1](step-by-step-example-dine-privateEndpoint-singleSubscription-policy.ps1) script. It follows the next steps:
...
You can renove the reference scenario using the [step-by-step-example-delete-dine-privateEndpoint-singleSubscription-policy.ps1](step-by-step-example-delete-dine-privateEndpoint-singleSubscription-policy.ps1) script.
